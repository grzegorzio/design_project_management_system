> **TL;DR:** Полный аналитический пакет для ERP-системы управления проектами — 
> от исследования (42 респондента) и BPMN до модели данных, API-контракта 
> и расчёта экономического эффекта (~340k₽/год). Основано на защищённой ВКР.

![status](https://img.shields.io/badge/status-analysis_complete-green)
...
Роли системы и их сценарии взаимодействия — [`docs/UML/use_case.png`](docs/UML/use_case.png).
